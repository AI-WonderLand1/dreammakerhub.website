...
function depthFromVelocity(velocity) {
    const clamped = Math.min(1, velocity / 2);
    return 0.3 + clamped * 0.7;
}
export function motionSampleToVec3(sample) {
    return {
...
export function computeSpatialTransform(samples, gesture) {
    if (samples.length === 0) {
...
export function classifySpatialGesture(samples, lateralGesture) {
...
export function normalizeSpatialCoordinates(coords, frame) {
    return {
