...
export const socialRenderers: Record<string, BlockRenderer> = {
  'social-feed': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'whatsapp-share': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'telegram-share': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'youtube-sub': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'discord-invite': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'github-star': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'facebook-page': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'twitter-timeline': ({ el, selectedId, selectElement, baseProps, children }) => {
