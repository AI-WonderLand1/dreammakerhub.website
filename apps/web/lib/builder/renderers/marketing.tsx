...
export const marketingRenderers: Record<string, BlockRenderer> = {
  'hero': ({ el, selectedId, selectElement, baseProps, children }) => {

  },
  'cta': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'testimonial': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'pricing': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'team-grid': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'logo-cloud': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'alert': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'stats-section': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'count-up': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'progress': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'chart': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'feature-grid': ({ el, selectedId, selectElement, baseProps, children }) => {
