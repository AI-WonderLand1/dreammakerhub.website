...
export const commerceRenderers: Record<string, BlockRenderer> = {
  'product-card': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'product-grid': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'add-to-cart': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'order-summary': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'wishlist': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'coupon': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'size-selector': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'color-swatches': ({ el, selectedId, selectElement, baseProps, children }) => {
