...
export const productsRenderers: Record<string, BlockRenderer> = {
  'product-page': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'product-filter': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'product-badge': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'stock-indicator': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'product-search': ({ el, selectedId, selectElement, baseProps, children }) => {
