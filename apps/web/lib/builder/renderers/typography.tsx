...
export const typographyRenderers: Record<string, BlockRenderer> = {
  ...
  'paragraph': ({ el, selectedId, selectElement, baseProps, children }) => {
      return <p {...baseProps}>{el.props.content}{children}</p>;
  },
  'rich-text': ({ el, selectedId, selectElement, baseProps, children }) => {
      return <div {...baseProps} dangerouslySetInnerHTML={{ __html: el.props.content || '' }} />;
  },
  'list': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'tooltip': ({ el, selectedId, selectElement, baseProps, children }) => {
