...
export const layoutRenderers: Record<string, BlockRenderer> = {
  ...
  'wrapper': ({ el, selectedId, selectElement, baseProps, children }) => {

  },
  'stack': ({ el, selectedId, selectElement, baseProps, children }) => {
      return <div {...baseProps}>{children || <span className="text-white/30 text-xs">{el.name}</span>}</div>;
  },
  'sidebar-layout': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'hero-layout': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'masonry': ({ el, selectedId, selectElement, baseProps, children }) => {
