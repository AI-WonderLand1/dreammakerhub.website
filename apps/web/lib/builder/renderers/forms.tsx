...
export const formsRenderers: Record<string, BlockRenderer> = {
  'button': ({ el, selectedId, selectElement, baseProps, children }) => {
      return <a {...baseProps} href={el.props.url || '#'} style={{ ...style, textDecoration: 'none' }}>{el.props.label || 'Button'}{children}</a>;
  },
  'buttons': ({ el, selectedId, selectElement, baseProps, children }) => {
      return (
        <div {...baseProps}>
  ...
  'input': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'checkbox': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'radio': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'search': ({ el, selectedId, selectElement, baseProps, children }) => {
