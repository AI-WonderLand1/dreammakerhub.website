...
export const widgetsRenderers: Record<string, BlockRenderer> = {
  'select': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'toggle': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'weather': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'clock': ({ el, selectedId, selectElement, baseProps, children }) => {
      return <div {...baseProps} style={{ ...style, fontFamily: 'monospace' }}>12:00:00{children}</div>;
  },
  'timer': ({ el, selectedId, selectElement, baseProps, children }) => {
  ...
  'qr-code': ({ el, selectedId, selectElement, baseProps, children }) => {
