...
import WebglEditorHost from "@/components/WebglEditorHost";
...
function WebglEditor() {
  ...
  useEffect(() => {
    ...
    const timeoutId = window.setTimeout(() => {
      ...
      pushToast("WebGL Studio editor did not become ready. Try again or use a different browser.", "error");
    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 text-white">
      ...
      <div className="mx-auto max-w-7xl space-y-4">
        <div className="flex items-center gap-2 border-b border-white/10 pb-3">
          <Link href="/wonder-build/webgl" className="text-sm text-white/50 hover:text-white">← Gallery</Link>
          <span className="text-white/20">/</span>
          <span className="text-sm text-white/80 font-mono">{sceneId}</span>
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className="relative rounded bg-white/10 px-2 py-1 text-xs font-mono text-white/80 hover:bg-white/20"
              >
                v{currentVersion}
              </button>
              {showVersions && (
            ...
            <div className="p-6">
              <div className="rounded-2xl border border-red-400/40 bg-red-500/10 px-6 py-8 text-center">
                ...
                <p className="mx-auto mt-2 max-w-2xl text-sm text-white/70">
                  The WebGL Studio editor did not report readiness in 30 seconds.
                </p>
                <div className="mt-5">
                  <button
            ...
            <>
              ...
              <WebglEditorHost
                ...
                onReady={() => {
                  ...
                  pushToast("WebGL Studio editor connected.", "success");
                }}
                onError={() => {
                  setBridgeLoading(false);
                  setBridgeFailed(true);
                  pushToast("Could not embed WebGL Studio. Retrying...", "error");
                }}
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          ...
          <Link href="/wonder-build" className="rounded-md border border-white/20 px-3 py-2 text-white/85 hover:bg-white/10">
            ← Wonder Build
          </Link>
        </div>
      </div>
...
export default function WebglEditorPage() {
  return (
