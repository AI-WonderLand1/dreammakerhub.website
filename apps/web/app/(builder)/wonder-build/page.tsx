...
import { TemplateThumbnail } from '@/lib/wonder-build/template-library/components/TemplateThumbnail';
      ...
      <section className="mx-auto max-w-[1440px] px-6 pb-16 pt-8 lg:px-8">
        ...
        <section id="templates" className="mt-9 scroll-mt-24">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div><div className="text-[10px] font-black uppercase tracking-[.2em] text-violet-300/60">Template Library</div><h2 className="mt-1 text-2xl font-black">Choose a real starting design</h2><p className="mt-1 text-sm text-white/40">Each card below is rendered from the same template element tree that gets written into builder-state.json and opened in Build.</p></div>
