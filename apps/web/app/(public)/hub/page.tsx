...
export default function HubPage() {
  ...
  function handleBuild() {
    ...
    if (mode === "website") {
      router.push(`/wonder-build/ai-builder?prompt=${encodeURIComponent(prompt)}&type=website`);
    } else {
          ...
          {filter !== "mine" && filteredTemplates.map((template) => (
            <Link
              ...
              href={template.type === "website"
                ? `/wonder-build/ai-builder?prompt=${encodeURIComponent(template.name)}&type=website`
