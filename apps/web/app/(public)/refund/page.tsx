  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="prose lg:prose-xl">
        ...
        <p>To request a refund, please contact our support team at <a href="mailto:support@dreammakerhub.website">support@dreammakerhub.website</a> with your order details. Refunds are processed within 5-7 business days and will be credited back to your original payment method.</p>
        ...
        <p>For enterprise subscriptions, refunds are handled on a case-by-case basis. Please contact us at <a href="mailto:contact@dreammakerhub.website">contact@dreammakerhub.website</a> for custom refund arrangements.</p>

        <h2>Technical Issues</h2>
        <p>If you're experiencing technical difficulties that prevent you from using AI Wonderland despite having an active subscription, please contact <a href="mailto:support@dreammakerhub.website">support@dreammakerhub.website</a>. We will provide either a service credit or refund if the issue cannot be resolved within 72 hours.</p>
      </div>
    </div>
  );
}
