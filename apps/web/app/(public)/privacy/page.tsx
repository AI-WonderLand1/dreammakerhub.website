...
word-break: break-word !important;
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600">Last updated <strong>June 22, 2026</strong></p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p>We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We process your information only when we have a valid legal reason to do so.</p>

          <p><strong>What personal information do we process?</strong> We collect personal information that you provide to us.</p>
          ...
          <p><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations with specific third parties.</p>
          ...
          <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a data subject access request, or by contacting us.</p>
        </div>
        ...
        <div id="infocollect">
          ...
          <h3 className="text-lg font-semibold">Personal information you disclose to us</h3>
        ...
        <div id="whoshare">
          <h2 className="text-xl font-bold">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        ...
        <div id="cookies">
          <h2 className="text-xl font-bold">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
          <p>We may use cookies and similar tracking technologies to collect and store your information. Some online tracking technologies help us maintain the security of our Services and your account, prevent crashes, fix bugs, save your preferences, and assist with basic site functions.</p>
        </div>

        <div id="ai">
          <h2 className="text-xl font-bold">5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</h2>
        ...
        <div id="sociallogins">
          <h2 className="text-xl font-bold">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
          <p>Our Services offer you the ability to register and log in using your third-party social media account details. Where you choose to do this, we will receive certain profile information about you from the social media provider.</p>
        </div>

        <div id="inforetain">
          <h2 className="text-xl font-bold">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        ...
        <div id="infosafe">
          <h2 className="text-xl font-bold">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
          <p>We have implemented appropriate and reasonable technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards, no electronic transmission over the Internet can be guaranteed to be 100% secure.</p>
        </div>

        <div id="infominors">
          <h2 className="text-xl font-bold">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>
        ...
        <div id="privacyrights">
          <h2 className="text-xl font-bold">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        ...
        <div id="request">
          <h2 className="text-xl font-bold">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
          <p>You may request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information.</p>
          <p>To request to review, update, or delete your personal information, please fill out and submit a data subject access request.</p>
        </div>
      </div>

      <div className="mt-8 text-center text-sm text-gray-500">
        <p>This Privacy Policy was created using Termly's <a href="https://termly.io/products/privacy-policy-generator/" target="_blank" rel="noopener external">Privacy Policy Generator</a></p>
      </div>
    </div>
  );
}