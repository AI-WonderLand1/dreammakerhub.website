            ...
            <div className="flex h-full items-center justify-center bg-gradient-to-br from-black via-[#0a0a0a] to-black text-white">
              <div className="text-center max-w-md">
                ...
                <div className="mt-6 flex gap-3 justify-center">
                  ...
                  <Link href="/wonder-build/builder" className="inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white/70 hover:bg-white/20 transition-colors">
                    Visual Builder
                  </Link>
                </div>
              </div>
