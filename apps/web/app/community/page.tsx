  ...
  const [posts, setPosts] = useState<ForumPost[]>([
    {
      ...
      title: 'Announcing WonderBuild v2.4 — Multi-Agent AI Builder Now Live!',
    ...
    },
    {
      ...
      category: 'showcase',
      preview: 'I used WonderBuild AI Builder to describe a cyberpunk cityscape and the three agents generated a full PlayCanvas scene with physics, materials, and lighting. Check out the results and the prompts I used.',
      tags: ['PlayCanvas', '3D', 'AI Builder'],
      upvotes: 94,
      commentsCount: 14,
      timeAgo: '5 hours ago',
      hasUpvoted: false
