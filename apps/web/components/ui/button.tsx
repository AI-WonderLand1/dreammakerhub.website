...
function Button({
  ...
  // @radix-ui/react-slot exports Slot itself as the renderable component.
  // Slot.Root belongs to the newer umbrella `radix-ui` namespace API and is
  // undefined when importing { Slot } from @radix-ui/react-slot.
