    ...
    },
    {
      ...
      headers: [
        ...
        { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://replit.com https://static.cloudflareinsights.com https://*.zdassets.com https://*.zendesk.com https://*.smooch.io https://*.ingest.*.sentry.io https://*.twilio.com",
