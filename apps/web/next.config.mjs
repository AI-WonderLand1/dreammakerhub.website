      ...
      headers: [
        ...
        { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
        {
          ...
          value: [
            ...
            `connect-src 'self' https://api.openai.com https://generativelanguage.googleapis.com https://api.openrouter.ai https://*.amplitude.com https://*.cloudflare.com https://www.googletagmanager.com https://*.google-analytics.com https://replit.com https://*.replit.dev https://*.replit.app https://csp-reporting.cloudflare.com ${appUrl} https://*.supabase.co wss://*.supabase.co https://*.zdassets.com https://*.zendesk.com https://*.smooch.io https://*.ingest.*.sentry.io https://*.twilio.com wss://*.zendesk.com wss://api.smooch.io wss://voice-js.roaming.twilio.com`,
